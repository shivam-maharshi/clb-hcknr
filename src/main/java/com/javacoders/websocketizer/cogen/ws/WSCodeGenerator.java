...
public class WSCodeGenerator implements CodeGenerator {
  ...
  private static MethodSpec constructOnMessageMethod(RestServiceBlueprint sb) {
     ...
     Builder methodBuilder = MethodSpec
        ...
        .addStatement("$T<Object> params = " + sb.getPackageName() + ".autogenerated.WSUtil.parseMessage(message, " + getRequestBodyClass(sb) + ".class)", List.class);
     ...
     methodBuilder
        .addStatement("session.getBasicRemote().sendText("+ sb.getPackageName() +".autogenerated.WSUtil.getJson(" + constructMethodInvocation(sb) + "))")
        .addParameter(Session.class, "session");
