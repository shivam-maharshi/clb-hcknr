...
public class CodeGenerator {
  ...
  public static void generate(ServiceBlueprint sb, File dir) throws IOException {
    ...
    String path = "C:/Shivam/Work/WorkSpace/hotel-booking-manager/HotelBookingManagerParent/HotelBookingManagerWeb/src/main/java/cz/fi/muni/pa165/hotelbookingmanagerrest/autogenerated";
    createFrameworkFile(WS_REQUEST, "WSRequest.java", sb.getPackge(), path);
    createFrameworkFile(UTIL, "Util.java", sb.getPackge(), path);
  }
