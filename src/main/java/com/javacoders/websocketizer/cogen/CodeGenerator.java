...
public class CodeGenerator {
  ...
  private static MethodSpec constructOnMessageMethod(ServiceBlueprint sb) {
     ...
     methodBuilder
        .addStatement("session.getBasicRemote().sendText("+ sb.getPackge() +".autogenerated.Util.getJson(" + constructMethodInvocation(sb) + "))")
        .addParameter(Session.class, "session");
        
     return methodBuilder.build();
  }
  
  private static void instantiateService(ServiceBlueprint sb, Builder builder) {
